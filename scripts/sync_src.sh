...
sync_src()
{
  ...
  yes | cp -rf ./scripts/environment_setup.sh ./rdk_ws/perception_ws/src/intel/ros2_openvino_toolkit/script/environment_setup.sh
  yes | cp -rf ./scripts/environment_setup_binary.sh ./rdk_ws/perception_ws/src/intel/ros2_openvino_toolkit/script/environment_setup.sh
