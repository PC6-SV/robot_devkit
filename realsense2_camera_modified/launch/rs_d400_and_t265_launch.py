...
def generate_launch_description():
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('realsense2_camera'), 'config', 'rs_cartographer.rviz')
    rviz_node = Node(
            package='rviz2',
    ...
    return LaunchDescription(
        ...
        ),rviz_node,tf_node1,tf_node2,tf_node3,tf_node4,tf_node5,depthimage_to_laserscan_node,cartographer_node,occupancy_grid_node
    ])
